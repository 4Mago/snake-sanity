...
class MuxVideoInputSetup extends _react.Component {
  ...
  constructor(props) {
    ...
    _defineProperty(this, "handleSaveToken", /*#__PURE__*/_asyncToGenerator(function* () {
      ...
      var enableSignedUrls = _this.state.enableSignedUrls || false;
      var signingKeyId = _this.state.signingKeyId || null;
      var signingKeyPrivate = _this.state.signingKeyPrivate || null;
      ...
      try {
        result = yield (0, _secrets.testSecrets)();
      } catch (err) {
        handleError(err);
        return;
      }
  ...
  render() {
    ...
    }), this.state.signingKeyId ? /*#__PURE__*/_react.default.createElement("p", {
      className: _Setup.default.paragraph
    }, "The signing key ID that Sanity will use is ", /*#__PURE__*/_react.default.createElement("code", null, this.state.signingKeyId), ". This key is only used for previewing content in the Sanity UI. You should generate a different key to use in your application server.") : null), /*#__PURE__*/_react.default.createElement("div", {
